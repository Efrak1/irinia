...
export const ButtonOrder2 = () => {
    ...
    return (
        <div className='flex sm:flex-row flex-col sm:flex-wrap w-full sm:w-auto'>
            {buttonLabels.map((label, index) => {
                const buttonClasses = activeButtonIndex === index
                    ? 'flex items-center justify-start text-[18px] sm:text-[20px] w-full sm:w-auto text-white bg-red-900 rounded-2xl mt-4 sm:mr-2 p-4' // Активная кнопка
                    : 'flex items-center justify-start text-[18px] sm:text-[20px] w-full sm:w-auto text-black rounded-2xl mt-4 sm:mr-2 p-4'; // Неактивные кнопки
...
export const ButtonOrder3 = () => {
    ...
    return (
        <div className='flex flex-col sm:flex-row sm:flex-wrap w-full sm:w-auto'>
            {buttonLabels.map((label, index) => {
                const buttonClasses = activeButtonIndex === index
                    ? 'flex text-start sm:items-center sm:justify-center text-[18px] sm:text-[20px] w-full sm:w-auto text-white bg-red-900 rounded-2xl mt-4 sm:mr-2 p-4' // Активная кнопка
                    : 'flex text-start sm:items-center sm:justify-center text-[18px] sm:text-[20px] w-full sm:w-auto text-black rounded-2xl mt-4 sm:mr-2 p-4'; // Неактивные кнопки
...
const SvgButtonOrder2 = () => {
    return (
        <svg className='relative ml-2 w-6 h-6' viewBox="0 0 24 24">
